  ...
  return (
    <section id="CV" className="w-full lg:mt-20 mt-4">
      <div className="hidden lg:flex lg:flex-col">
        ...
        <button className="w-full lg:w-fit flex items-center justify-center rounded-md px-2 py-2 mb-3 bg-gray-secondary bg-opacity-30 tracking-widest text-sm uppercase text-primary hover:px-6 hover:bg-yel-primary transform ease-in-out duration-300">
