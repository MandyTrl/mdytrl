  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full flex flex-col items-center justify-around">
        <p className="uppercase font-rokkitt text-2xl font-thin tracking-[0.7em]">coded with</p>

        <div className="flex items-center border-t-[0.5px] border-b-[0.5px] border-gray-secondary py-20 px-10">
